...
export function Header() {
  ...
  // 3) На всех остальных путях: слева «Home» (иконка+текст), справа остальные пункты
  return (
    <header className="bg-white p-4 shadow flex items-center justify-between h-[58px]">
      <button
